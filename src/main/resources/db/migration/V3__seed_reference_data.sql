...
VALUES (
        'ADMIN',
        'Admin',
        'the.supporter.admin@gmail.com',
        '$2a$10$HCVQ.JMwNqMeYehBdDnAsO914dBBXn780hvx17uW/WrwUEUkrL9OG',
        'Khoa CNTT',
        'ADMIN',
        'HOAT_DONG'
    );
...
VALUES (
    ...
    (
        'NP02',
        'Phòng mạng',
        'Phòng thực hành mạng và hệ thống'
    ),
    (
        'NP03',
        'Phòng nghiên cứu',
        'Phòng robot, UAV và nghiên cứu chuyên ngành'
    ),
    (
        'NP04',
        'Phòng đa phương tiện',
        'Phòng trình chiếu và học nhóm'
    ),
    (
        'NP05',
        'Phòng máy chủ',
        'Phòng máy chủ và hạ tầng'
    );
...
VALUES (
    ...
    (
        ...
        TRUE,
        TRUE,
        'Thiết bị yêu cầu giảng viên hướng dẫn'
    ),
    (
        'UAV',
        'UAV',
...
SELECT CONCAT('TN-', MaPhong), 'PHONG', MaPhong
FROM Phong;