...
final class RegistrationForms {
	...
	static final class RegistrationForm {
		...
		static RegistrationForm from(RegistrationResponse response) {
		...
		RegistrationFormRequest toRequest() {
	...
	static final class ScheduleForm {
		...
		ScheduleForm(Integer dayOfWeek, Integer periodId) {
			this.dayOfWeek = dayOfWeek;
			this.periodId = periodId;
		}

		RegistrationScheduleRequest toRequest() {
	...
	static final class CancellationForm {
