...
import com.example.labmanagement.usage.application.SessionDeviceConditionRequest;
import com.example.labmanagement.usage.application.SessionDeviceResponse;
import com.example.labmanagement.usage.application.SessionIncidentRequest;
...
final class UsageSessionForms {

	private UsageSessionForms() {
	}

	static final class CheckInForm {
		...
		static CheckInForm from(UsageSessionResponse response) {
		...
		SessionCheckInRequest toRequest() {
	...
	static final class CheckOutForm {
		...
		static CheckOutForm from(UsageSessionResponse response) {
		...
		SessionCheckOutRequest toRequest() {
