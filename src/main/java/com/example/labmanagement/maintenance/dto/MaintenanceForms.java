...
public final class MaintenanceForms {
	...
	public static class CreateForm {
		...
		public MaintenanceCreateRequest toRequest() {
	...
	public static class UpdateForm {
		...
		public static UpdateForm from(MaintenanceResponse maintenance) {
		...
		public MaintenanceUpdateRequest toRequest() {
