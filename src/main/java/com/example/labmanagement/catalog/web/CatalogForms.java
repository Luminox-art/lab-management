...
import com.example.labmanagement.catalog.application.RoomCreateRequest;
...
import com.example.labmanagement.catalog.application.RoomUpdateRequest;
...
public final class CatalogForms {
	...
	public static final class RoomForm {
		...
		static RoomForm from(RoomResponse room) {
	...
	public static final class DeviceForm {
		...
		static DeviceForm from(DeviceResponse device) {
	...
	public static final class RoomGroupForm {
		...
		static RoomGroupForm from(RoomGroupResponse group) {
	...
	public static final class DeviceTypeForm {
		...
		static DeviceTypeForm from(DeviceTypeResponse type) {
